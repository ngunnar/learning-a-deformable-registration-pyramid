...
config = {
    ...
    'epochs':100,
    'lr':0.5e-5,
    'weights': './Task_models/20201013-165823/task3_ncc_20201013-165823',
    'use_atlas': use_atlas,
    'atlas_wt': 3.0,
    'seg_loss': 'dice',
    'data_loss': 'ncc',
...
config['betas'] = [i*5 for i in config['betas']]
...
with mirrored_strategy.scope():
    model, loss, loss_weights = create_model(config = config, name="Model", task=3)
    ...
    model.save_weights('task3_model')
